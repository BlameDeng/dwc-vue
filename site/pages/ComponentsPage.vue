  ...
  <div class="components-page">
    <div class="nav-bar">
      <dwc-menu v-model:selected-key="selectedKey">
        <dwc-menu-item value="overview" @click="onClick('overview')">
          组件总览
        </dwc-menu-item>
        <dwc-menu-group>
          ...
          <template v-slot:default>
            <dwc-menu-item value="button" @click="onClick('button')">
              Button 按钮
            </dwc-menu-item>
          </template>
        </dwc-menu-group>
        <dwc-menu-group>
          ...
          <template v-slot:default>
            <dwc-menu-item value="menu" @click="onClick('menu')">
              Menu 导航菜单
            </dwc-menu-item>
          </template>
        </dwc-menu-group>
        <dwc-menu-group>
          ...
          <template v-slot:default>
            <dwc-menu-item value="input" @click="onClick('input')">
              Input 输入框
            </dwc-menu-item>
            <dwc-menu-item value="select" @click="onClick('select')">
              Selelct 选择器
            </dwc-menu-item>
            <dwc-menu-item value="switch" @click="onClick('switch')">
              Switch 开关
            </dwc-menu-item>
          </template>
        </dwc-menu-group>
        <dwc-menu-group>
          ...
          <template v-slot:default>
            <dwc-menu-item value="tabs" @click="onClick('tabs')">
              Tabs 标签页
            </dwc-menu-item>
          </template>
        </dwc-menu-group>
